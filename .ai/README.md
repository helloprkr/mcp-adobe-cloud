...
- Additional technology-specific MCP rules are available in the blueprints directory
...
- [v0.dev](https://v0.dev/) is a tool for generating React components from screenshots and chat. Currently, they don't have a Cursor plugin, so you can use [v0.md](plugins/v0.md) as a bridging prompt.
- [v0.md](plugins/v0.md): Guide for generating React component prompts for v0.dev - a tool for creating UI components via natural language and visual references
